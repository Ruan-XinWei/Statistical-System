            ...
            <div class="main_info">
                ...
                <div class="main_info_top_nav">
                    <ul class="clearfix">
                        <li><a href="../update_page/update_student.php?<?php echo $url_user_id ?>"><span>更改学生信息</span></a></li>
                        <li><a href="../update_page/update_teacher.php?<?php echo $url_user_id ?>"><span>更改老师信息</span></a></li>
                        <li class="hightlight"><a href="../update_page/update_team.php?<?php echo $url_user_id ?>"><span>更改团队信息</span></a></li>
                        <li><a href="../update_page/update_activity.php?<?php echo $url_user_id ?>"><span>更改活动信息</span></a></li>
                        <li><a href="../update_page/update_achievement.php?<?php echo $url_user_id ?>"><span>更改成果信息</span></a></li>
                        <li><a href="../update_page/update_student_team.php?<?php echo $url_user_id ?>"><span>更改组队信息</span></a></li>
                    </ul>
                ...
                <div class="main_body clearfix">
                    <form action="<?php echo $_SERVER['PHP_SELF'] . '?' . urldecode($_SERVER['QUERY_STRING']); ?>" method="post">
                        ...
                        <input type="text" name="newnum" id="newnum" placeholder="请输入新团队人数">
                        <input type="text" name="newslogan" id="newslogan" placeholder="请输入新团队口号">
                    ...
                    <div class="main_body_info">
                        ...
                        $newnum = get_input("newnum");
                        $newslogan = get_input("newslogan");
                        if ($id != '' || $name != '' || $num != '' || $slogan != '') {
                            ...
                            if ($index / 10 >= 1) {
                                $error_info = $error_info . ',num=\'' . $num . '\'';
                                $index -= 10;
                            }
                            if ($index >= 1) {
                                $error_info = $error_info . ',slogan=\'' . $slogan . '\'';
                                $index = 0;
                            }
                            ...
                            $query = 'SELECT * FROM ' . TEAM_TABLE . ' ' . $where_section;
                            ...
                            if ($array_count == 0) {
                                ...
                                $set_section = ($newid == '' ? '' : (',id="' . $newid . '"')) . ($newname == '' ? '' : (', name="' . $newname . '"')) . ($newnum == '' ? '' : (', num="' . $newnum . '"')) . ($newslogan == '' ? '' : ', slogan="' . $newslogan . '"');
                                $set_section = 'SET ' . substr($set_section, 1);
                                $query = 'UPDATE ' . TEAM_TABLE . ' ' . $set_section . ' ' . $where_section . ';';
