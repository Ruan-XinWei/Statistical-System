            ...
            <div class="main_info">
                ...
                <div class="main_body clearfix">
                    <form action="<?php echo $_SERVER['PHP_SELF'] . '?' . urldecode($_SERVER['QUERY_STRING']); ?>" method="post">
                        <input type="text" name="team_id" id="team_id" placeholder="请输入需要添加的团队号">
                        <input type="text" name="activity_id" id="activity_id" placeholder="请输入需要添加的课外活动编号">
                        <input type="text" name="time" id="time" placeholder="请输入需要添加的完成时间">
                        <input type="text" name="teacher_id" id="teacher_id" placeholder="请输入需要添加的指导老师编号">
                        <input type="text" name="academy" id="academy" placeholder="请输入需要添加的报送学院">
                    ...
                    <div class="main_body_info">
                        ...
                        if ($team_id != '' && $activity_id != '' && $time != '' && $teacher_id != '' && $academy != '') {
                            ...
                            ("$team_id", "$activity_id", "$time", "$teacher_id", "$academy");
                            STRING;
                            $query = 'INSERT INTO ' . ACHIEVEMENT_TABLE . '(team_id, activity_id, time, teacher_id, academy) VALUES ' . $values_section;
