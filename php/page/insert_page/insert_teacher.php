            ...
            <div class="main_info">
                ...
                <div class="main_body clearfix">
                    <form action="<?php echo $_SERVER['PHP_SELF'] . '?' . urldecode($_SERVER['QUERY_STRING']); ?>" method="post">
                        <input type="text" name="id" id="id" placeholder="请输入需要添加的老师编号">
                        <input type="text" name="name" id="name" placeholder="请输入需要添加的姓名">
                        <input type="text" name="sex" id="sex" placeholder="请输入需要添加的性别">
                        <input type="text" name="age" id="age" placeholder="请输入需要添加的年龄">
                    ...
                    <div class="main_body_info">
                        ...
                        if ($id != '' && $name != '' && $sex != '' && $age != '') {
                            ...
                            ("$id", "$name", "$sex", "$age");
                            STRING;
                            $query = 'INSERT INTO ' . TEACHER_TABLE . '(id, name, sex, age) VALUES ' . $values_section;
