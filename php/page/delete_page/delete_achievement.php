            ...
            <div class="main_info">
                ...
                <div class="main_info_top_nav">
                    <ul class="clearfix">
                        ...
                        <li><a href="../delete_page/delete_team.php?<?php echo $url_user_id ?>"><span>删除团队信息</span></a></li>
                        <li><a href="../delete_page/delete_activity.php?<?php echo $url_user_id ?>"><span>删除活动信息</span></a></li>
                        <li class="hightlight"><a href="../delete_page/delete_achievement.php?<?php echo $url_user_id ?>"><span>删除成果信息</span></a></li>
                        <li><a href="../delete_page/delete_student_team.php?<?php echo $url_user_id ?>"><span>删除组队信息</span></a></li>
                    </ul>
                </div>
                <div class="main_body clearfix">
                    <form action="<?php echo $_SERVER['PHP_SELF'] . '?' . urldecode($_SERVER['QUERY_STRING']); ?>" method="post">
                        <input type="text" name="team_id" id="team_id" placeholder="请输入需要删除的团队号">
                        <input type="text" name="activity_id" id="activity_id" placeholder="请输入需要删除的课外活动编号">
                        <input type="text" name="time" id="time" placeholder="请输入需要删除的完成时间">
                        <input type="text" name="teacher_id" id="teacher_id" placeholder="请输入需要删除的指导老师编号">
                        <input type="text" name="academy" id="academy" placeholder="请输入需要删除的报送学院">
                    ...
                    <div class="main_body_info">
                        ...
                        if ($team_id != '' || $activity_id != '' || $time != '' || $teacher_id != '' || $academy != '') {
                            ...
                            $query = 'DELETE FROM ' . ACHIEVEMENT_TABLE . ' ' . $where_section;
